...
def proxy():
    ...
    if not target_url:
        # Vercel ping ou accès direct sans paramètre
        return "<h2>Proxy actif. Ajoutez ?url=https://site.com</h2>", 200
    ...
    if 'text/html' in content_type:
        ...
        # Réécriture des data-src (lazy loading)
    ...
    # Sinon, on renvoie brut (images, js, css, etc.)
    return Response(
        resp.content,
